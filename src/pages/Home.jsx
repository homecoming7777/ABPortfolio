         ...
         <div className="lg:cursor-none pb-10 w-full overflow-x-hidden relative overflow-hidden">
            ...
            <section className="lg:grid lg:grid-cols-2">
               <div className="pt-25 sm:pt-20 lg:pt-30">
                  ...
                  <p className="text-gray-400 font-extralight text-center mx-10 mt-2 lg:text-left lg:ml-25">
            ...
            <section className="pb-10 lg:pt-5">
               ...
               <div>
                  <h2
                     data-aos="fade-left"
                     className="bbh-sans-bogle-regular uppercase pl-5 text-5xl pt-30 text-[#D7263D] sm:pt-40 sm:text-6xl lg:pt-20"
                  >
                     +about
                  </h2>
               ...
               <div className="pt-5" data-aos="fade-right">
                  <p className="pl-5 opacity-70 text-gray-400 mt-3 text-left mx-5 sm:text-3xl sm:pl-10 sm:pt-20 md:mx-40">
            ...
            <section className="sm:mt-60">
               <h2
                  className="bbh-sans-bogle-regular pl-5 text-5xl pt-10 text-[#D7263D] uppercase font-bold"
                  data-aos="fade-left"
               >
                  +tech arsenal
               </h2>
            ...
            <section id='Projects'>
               <h2
                  data-aos="fade-left"
                  className="bbh-sans-bogle-regular uppercase font-bold text-5xl pt-30 text-[#D7263D] sm:pt-40 sm:text-6xl lg:pt-20"
               >
                  +featured projects
               </h2>
            ...
            <section className="pb-30" id='contact'>
               <h2
                  data-aos="fade-down"
                  className="bbh-sans-bogle-regular uppercase font-bold text-5xl pt-20 text-[#D7263D] sm:pt-20 sm:text-6xl lg:pt-20 md:pt-20 text-center"
               >
                  +Let’s work together
               </h2>
               ...
               <p
                  data-aos="zoom-out"
                  className="text-gray-400 text-center text-sm mx-10 mt-10 md:text-2xl lg:text-3xl"
               >
            ...
            <ul className="flex gap-5 -mt-30 justify-self-center">
               <li>
                  <a href="https://instagram.com/a07070_7">
